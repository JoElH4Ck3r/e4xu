	...
	public class Check extends DIV implements ISkinnable
	{
		...
		*/
		...
		public function set skin(value:Vector.<ISkin>):void 
		{
			...
			else this._skin = null;
			if (this._skin)
			{
				this._button.states[UP_STATE] = 
					this._skin.produce(_button, UP_STATE);
				this._button.states[DOWN_STATE] = 
					this._skin.produce(_button, DOWN_STATE);
				this._button.states[OVER_STATE] = 
					this._skin.produce(_button, OVER_STATE);
		...
		*/
		...
		public function Check() 
		{
			...
			super.addEventListener(
				...
				this.button_overHandler, false, int.MAX_VALUE);
			super.addEventListener(
