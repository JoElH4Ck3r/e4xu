...
public class ASTBuilder {
	...
	private static LinkedListTree synthesizeAS3Class(String className) {
		...
		clazz.appendToken(TokenBuilder.newNewline());
	...
	public static LinkedListTree newObjectBlock(int type) {
	...
	public static LinkedListTree newObjectLiteral() {
		LinkedListTree lit = newObjectBlock(AS3Parser.OBJECT_LITERAL);
		return lit;
	}
